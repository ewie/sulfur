...
define([
  ...
  'sulfur/ui/model'
], function (SimpleListValue, Collection, Model) {
  ...
  return Model.clone({
    ...
    get valueType() {
      return SimpleListValue.withItemValueType(this.factory.itemValueModel.valueType);
    },

    validateWithType: function (type) {
      var itemType = type.itemType || type.primitive.itemType;
