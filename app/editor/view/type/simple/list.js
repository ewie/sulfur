...
define([
  ...
  'text!app/editor/html/type/simple/list.html'
], function (View, ViewAccess, ViewsAccess, Accessor, Blueprint, html) {
  ...
  var blueprint = Blueprint.create({
    ...
    accessors: [
      Accessor.create('itemType', '[name = "item-type"]', ViewAccess),
